...
SRCS = main.cpp Initiator.cpp Level.cpp CompoundModel.cpp ShaderProgram.cpp ArtificeShaderProgram.cpp EventController.cpp Engine3D.cpp Engine3DEd.cpp Engine3DEdModel.cpp #$(IMGUI_SRCS)
OBJS = main.o Initiator.o Level.o CompoundModel.o ShaderProgram.o ArtificeShaderProgram.o EventController.o Engine3D.o Engine3DEd.o Engine3DEdModel.o #$(IMGUI_OBJS)
...
model :
	$(CC) -c CompoundModel.cpp $(COMPILER_FLAGS)
...
engine :
	$(CC) -c Engine3D.cpp Engine3DEd.cpp Engine3DEdModel.cpp $(COMPILER_FLAGS)

clean :
	rm *.o *.exe artifice || true

#objs : clean gui main init level model shader event engine
objs : clean main init level model shader event engine
