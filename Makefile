...
SRCS = main.cpp Initiator.cpp Level.cpp CompoundModel.cpp ShaderProgram.cpp ArtificeShaderProgram.cpp EventController.cpp Engine3D.cpp Engine3DEd.cpp #$(IMGUI_SRCS)
OBJS = main.o Initiator.o Level.o CompoundModel.o ShaderProgram.o ArtificeShaderProgram.o EventController.o Engine3D.o Engine3DEd.o #$(IMGUI_OBJS)
